...
public class ReservationController {
    ...
    @PostMapping("/create")
    public ResponseEntity<Reservation> makeReservation(@RequestBody ReservationRequestBody reservationRequestBody) {
        return ResponseEntity.ok(reservationService.createReservation(reservationRequestBody));
    }
